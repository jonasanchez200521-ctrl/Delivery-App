...
namespace Delivery.API
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // CORS: permite que Delivery.Web (Blazor Server) consuma la API.
            ...
            // Sin UseHttpsRedirection: Delivery.Web llama a la API por HTTP en local
